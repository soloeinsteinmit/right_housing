...
const FormHeader = React.memo(() => (
  ...
  >
    ...
    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
      Whether you're seeking support, looking to volunteer, or want to learn more
      about our programs, we're here to help every step of the way.
    </p>
  </motion.div>
));
...
const ContactForm = () => {
  ...
  const renderActiveStep = useMemo(() => {
    switch (activeStep) {
      ...
      case 2:
        return <ContactDetailsStep formData={formData} onChange={handleChange} />;
      case 3:
