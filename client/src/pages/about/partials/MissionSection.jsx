    ...
    <div className="bg-white rounded-3xl p-10 shadow-xl">
      ...
      <div className="mt-8">
        <p className="text-gray-600 leading-relaxed">
          Our mission is to empower individuals transitioning from incarceration
          or recovering from addiction by providing comprehensive housing
          support and essential resources. We focus on recovery, personal
          growth, and independence through job training, financial literacy,
          emotional support, and life skills development. By fostering a safe,
          supportive environment and offering holistic services, we guide each
          individual toward reintegration, self-sufficiency, and a transformed
          future.
        </p>
      </div>
    ...
    <div className="bg-white rounded-3xl p-10 shadow-xl">
      ...
      <div className="mt-8 h-full">
        <p className="text-gray-600 leading-relaxed">
          ...
          incarceration, and mental health by providing housing solutions and
          comprehensive support, and a pathway from transitional living to
          independent living. We envision a future where everyone can rebuild
          their lives and thrive in self-sufficiency and security.
        </p>
      </div>
...
const ConnectingLines = React.memo(() => (
